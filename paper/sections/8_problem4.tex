...
表 6 的原始数据见 \texttt{results/q4/table6.csv}。图~\ref{fig:q4event}展示收缩条件下的事件定位，图~\ref{fig:q4material}展示材料坐标变换和事件定位流程。

\begin{figure}[H]
  \centering
  \includegraphics[width=0.80\textwidth]{../figures/q4/q4_threshold_event.pdf}
  \caption{问题四收缩条件下的全域达标事件}
  \label{fig:q4event}
\end{figure}
