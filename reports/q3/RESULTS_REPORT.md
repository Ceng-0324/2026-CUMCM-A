...
环境延拓敏感性对照见 [`../../results/q4/formal_sensitivity.json`](../../results/q4/formal_sensitivity.json)：将 4 h 后的末小时均值改为最后观测值，$N=1024$ 的事件变为 57.16944532 h，较正式口径提前 18.28 min。该影响显著大于网格误差，因此正式结果保留末小时均值，并将延拓方式作为条件假设报告。
